...
class SpecList extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    const handleReady = () => {
      navigation.navigate('RegisterMaster', { specs: arrGlob });
      console.log(arrGlob);
    };
    ...
    return {
      ...
      headerRight: (
        <TouchableOpacity onPress={handleReady} style={{ paddingRight: 10 }}>
          <Text
...
)(hoistStatics(withTranslation()(SpecList), SpecList));
