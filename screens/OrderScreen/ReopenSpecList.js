...
class ReopenSpecList extends React.Component {
  ...
  choose = (index) => {
    this.props.navigation.navigate('ReopenOrder', { spec: index });
  };
...
)(hoistStatics(withTranslation()(ReopenSpecList), ReopenSpecList));
