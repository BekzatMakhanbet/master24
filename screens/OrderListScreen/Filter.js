...
class FilterMasters extends React.Component {
  ...
  handleReady = () => {
    ...
    this.props.navigation.navigate('AllMaster', { filter: specListToSend });
  };
...
)(hoistStatics(withTranslation()(FilterMasters), FilterMasters));
